<x-layout>
    <section class="px-44">
        <div>
            <img src="/img/jalase.jpg" alt="jalase" class="w-full h-[50vh]">
        </div>
        <p class="mt-6 text-justify">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ، و با استفاده از طراحان
            گرافیک است،
            چاپگرها و متون
